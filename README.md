...
![Загрузка данных](media/data-upload.png)
...
![Конструктор добавления шума](media/noise-constructor.png)
...
### 3. Обучение модели
![Обучение модели](media/model-training.png)
...
![Тестирование модели](media/model-testing.png)
